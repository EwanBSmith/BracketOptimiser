...
public:
	analysisResults runAnalysis(Bracket bracketForAnalysis, double load) {
		...
		double tensileArea = bracketForAnalysis.thickness * ((bracketForAnalysis.lugRadius * bracketForAnalysis.lugRadius) - bracketForAnalysis.holeDiameter);
		double shearArea = (bracketForAnalysis.lugRadius-((bracketForAnalysis.holeDiameter/2)*cos(40)))*2 * bracketForAnalysis.thickness;
